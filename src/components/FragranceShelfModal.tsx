...
import { X, Search, Check, Sparkles, SlidersHorizontal, RotateCcw, CheckSquare, Layers } from 'lucide-react';
import { PERFUME_DATABASE, SHELF_PRESETS } from '../data/fragrances';
...
export const FragranceShelfModal: React.FC<FragranceShelfModalProps> = ({
  ...
  const filteredPerfumes = useMemo(() => {
    ...
    return PERFUME_DATABASE.filter((item) => {
      // Поиск по названию, бренду или нотам
      const matchesSearch =
        !q ||
