...
import { Sparkles, BookOpen, ShieldCheck, Layers } from 'lucide-react';
  ...
  return (
    <header className="w-full border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-xl sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        {/* Right Action: Shelf, Manifesto & Guarantee */}
        <div className="flex items-center gap-2.5">
          ...
          {onOpenShelf && (
            <button
              onClick={onOpenShelf}
              className="flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700/80 transition-all hover:border-amber-500/50 shadow-sm cursor-pointer"
